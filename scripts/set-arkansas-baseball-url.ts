// scripts/set-arkansas-baseball-url.ts
...
async function main() {
  ...
  if (!APPLY) {
    ...
    console.log(
      "npx tsx scripts/set-arkansas-baseball-url.ts --apply",
    );
  ...
  if (
    ...
    throw new Error(
      "Arkansas URL update could not be verified.",
    );
  }

  console.log(
    "Arkansas baseball URL updated successfully.",
  );
}
