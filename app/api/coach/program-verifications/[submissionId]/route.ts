...
function buildProgramUpdate(data: any) {
  return {
    ...
    xUrl: cleanString(data?.programXUrl, 1000),
    instagramUrl: cleanString(data?.programInstagramUrl, 1000),
    youtubeUrl: cleanString(data?.programYoutubeUrl, 1000),
  ...
  const updated = await prisma.$transaction(async (tx) => {
    ...
    await tx.college.update({
      ...
      data: {
        ...
        programInstagramUrl: programUpdate.instagramUrl,
        programXUrl: programUpdate.xUrl,
