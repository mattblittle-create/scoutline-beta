...
export default function CancelAccountControl(props: Props) {
  ...
  const bodyText =
    props.kind === "TEAM"
      ? `In order to cancel your ScoutLine Teams account, click the Confirm button below. If you do not want to cancel your account, click the Never Mind button below. Cancelling your account will stop future billing and your Teams account will remain active until the end of your current billing period. At that time, log-in access to ScoutLine will be removed and you will no longer be able to access or edit the player profile(s) or send teaser card(s) to coaches. If you need to remove player(s) from the roster in order to update monthly billing per player, do this from your Team Roster section.`
      : `In order to cancel your ScoutLine account, click the Confirm button below. If you do not want to cancel your account, click the Never Mind button below. Cancelling your account will stop future billing and your account will remain active until the end of your current billing period. At that time, log-in access to ScoutLine will be removed and you will no longer be able to access or edit the player profile or send the teaser card to coaches. If you still want to have access to your player profile without being charged monthly, you can change the Plan Tier to Redshirt — FREE. Note that updating the Plan Tier may result in less functionality on the profile compared to your current plan.`;
