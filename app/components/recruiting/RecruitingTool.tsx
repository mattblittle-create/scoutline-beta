...
type RecruitingToolMode = "player" | "parent" | "team" | "coach";

type RecruitingToolProps = {
  mode?: RecruitingToolMode;
  playerProfileId?: string | null;
  backHref?: string;
  backLabel?: string;
};

export default function RecruitingTool({
  mode = "player",
