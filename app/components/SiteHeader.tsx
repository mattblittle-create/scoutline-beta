  ...
  return (
    <header className="sl-header">
      <style>{`
        ...
        .sl-login-btn { color: var(--sl-accent); font-weight:600; background:transparent; border:none; cursor:pointer; font-size: 1rem; text-decoration: underline; }
        ...
        .sl-item:hover { background:#f8fafc; text-decoration:none; }
      ...
      <nav className="sl-nav">
        ...
        <div className="sl-right">
          ...
          {/* Log In with dropdown + click-through */}
          <div style={{ position: "relative" }} onMouseEnter={openLogin} onMouseLeave={scheduleCloseLogin}>
            <Link
              ...
              onClick={(e) => {
                if (loginOpen) {
                  e.preventDefault(); // allow dropdown click-through
                  instantCloseLogin();
                } else {
                  // Let link go to /login if just clicked
                }
              }}
              onFocus={openLogin}
            >
