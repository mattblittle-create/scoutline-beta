  ...
  return (
    <main style={{ maxWidth: 860, margin: "0 auto" }}>
      ...
      <p style={{ color: "#475569", marginTop: 4 }}>
        ...
        months, Stats after each season completes, and Video and References as they become available.
      </p>
      ...
      >
        ...
        <a href="/dashboard/player/profile/billing" style={{ textDecoration: "none" }}>
          <button
            type="button"
            style={{
              height: 36,
...
{activeTab === "Core" && (
  ...
  />
        ...
        {activeTab === "Academics" && (
          ...
          uploadEndpoint="/api/upload/academic" // ✅ (optional) explicit endpoint; can omit since it defaults
            // values
            gradYear={gradYear}
            hsName={hsName}
            hsCity={hsCity}
      ...
      Save your profile to generate a public URL.
          ...
          {(() => {
            ...
            return (
              ...
              >
                <a href="/dashboard/player/profile/billing" title="Manage your plan" style={{ textDecoration: "none" }}>
                  <button
                    type="button"
                    style={{
                      fontSize: 13,
