  ...
  return (
    <section style={{ padding: 24, maxWidth: 960, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 16 }}>
        <Badge>{p.handedness}</Badge>
        <Badge>{p.height}</Badge>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 16 }}>
        ...
        <Card title="Metrics">
          <ul style={{ margin: 0, paddingLeft: 16, lineHeight: 1.8 }}>
            ...
            {p.metrics.outfieldVelo && <li>OF Velo: <strong>{p.metrics.outfieldVelo}</strong></li>}
            {p.metrics.catcherPop && <li>Pop Time: <strong>{p.metrics.catcherPop}</strong></li>}
